...
from src.app.endpoints import chat_api_router, image_api_router, transcription_api_router
...
class APIRouterInstallation:
    ...
    def install_api_routers(app: FastAPI):
        routers = [chat_api_router, transcription_api_router, image_api_router]
